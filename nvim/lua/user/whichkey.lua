...
local mappings = {
  ...
  g = {
    ...
    s = { "<cmd>Telescope git_status layout_config={width=0.9,height=0.9}<cr>", "Open changed file" },
    b = { "<cmd>Telescope git_branches layout_config={width=0.9,height=0.9}<cr>", "Checkout branch" },
    c = { "<cmd>Telescope git_commits layout_config={width=0.9,height=0.9}<cr>", "Checkout commit" },
